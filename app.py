...
/* ===== DEFINITIVE HOME TOP-ALIGNMENT FIX ===== */
.stApp:has(.home-shell) [data-testid="stAppViewContainer"] {
...
/* ============================================================
   DEFINITIVE FIX: Streamlit vertical-centering / top blank area
   This ONLY changes the Home page container positioning.
   ============================================================ */

/* The actual content wrapper that contains .home-shell */
[data-testid="stAppViewContainer"] .main .block-container:has(.home-shell) {
    display:block !important;
    position:relative !important;
    top:0 !important;
...
/* Stop any parent flex/grid centering */
[data-testid="stAppViewContainer"] .main:has(.home-shell) {
    display:block !important;
    position:relative !important;
    top:0 !important;
    margin:0 !important;
...
/* Remove Streamlit's default vertical offset from all ancestors */
[data-testid="stAppViewContainer"]:has(.home-shell),
[data-testid="stAppViewContainer"]:has(.home-shell) > div,
[data-testid="stAppViewContainer"]:has(.home-shell) > .main,
[data-testid="stAppViewContainer"]:has(.home-shell) .main > div {
    margin-top:0 !important;
    padding-top:0 !important;
}

/* Home itself must begin at the first available pixel */
.home-shell {
    position:relative !important;
    top:0 !important;
    margin-top:0 !important;
